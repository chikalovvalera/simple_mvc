...
public class IdProvider implements InitializingBean, DisposableBean, BeanPostProcessor {
    ...
    private void initIdProvider() {
        logger.info("provide INIT");
    }

    private void destroyIdProvider() {
        logger.info("provide DESTROY");
    }

    private void defaultInit(){
        logger.info("provide INIT in provider");
    }

    private void defaultDestroy(){
        logger.info("provide DESTROY in provider");
    }
    ...
    public void destroy() throws Exception {
        logger.info("DesposibleBean destroy invoked");
    }
